...
def recommend_parse_args():
    ...
    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="Yelp", help="Choose a dataset:[FilmTrust,ml-100k,ml-1M,Automotive，Yelp,douban]")
    ...
    parser.add_argument('--model_name', type=str, default='GMF', help='[GMF, SSL4Rec, XSimGCL...]')
    ...
    parser.add_argument('--seed', nargs='?', default=1234, help='random seed')
    parser.add_argument('--topK', nargs='?', default='', help='topK')
    # ===== save model ===== #
