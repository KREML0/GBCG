...
def attack_parse_args():
    ...
    parser.add_argument('--attackModelName', type=str, default="BandwagonAttack", metavar='N')
    ...
    parser.add_argument('--Epoch', type=int, default=50, metavar='N', help='bi-level optimzation epoch')
    parser.add_argument('--innerEpoch', type=int, default=25, metavar='N', help='inner epoch')
    parser.add_argument('--outerEpoch', type=int, default=25, metavar='N', help='outer epoch')
    ...
    parser.add_argument('--lr_G', type=float, default=0.0045)
    parser.add_argument('--lr_D', type=float, default=0.0045)
